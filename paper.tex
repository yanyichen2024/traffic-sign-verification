...
代码已开源至 \url{https://github.com/yanyichen2024/traffic-sign-verification}。这里使用的是浏览器访问地址；若用命令行克隆，可使用 \texttt{git clone} 加仓库地址 \url{https://github.com/yanyichen2024/traffic-sign-verification.git}。

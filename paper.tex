...
代码已开源至 \href{https://github.com/yanyichen2024/traffic-sign-verification}{https://github.com/yanyichen2024/traffic-sign-verification}。这里使用的是浏览器访问地址；若用命令行克隆，可使用 \texttt{git clone https://github.com/yanyichen2024/traffic-sign-verification.git}。
